...
**chemical reactios**: The breaking and creating of bonds between different substances (**requiring energy**).

**activation energy**: The amount of energy needed to start a chemical reaction.

**potential energy**: Amount of energy that is present in the substance before the chemical reaction started.

**substrates (reactants)**: substances that are rearranged in a reaction.

**products**: The final rearranged substances of a reaction.

### The Law of Conservation of Matter

The amount that existed at the beginning of a chemical reaction must equal the amount of matter existing at the end of the reaction.
...
Enzymes are also called **catalysts** because they **speed up reactions**.

Enzymes can fit only one substrate (usually specifically one) in their **active site** (lock & key)

A substrate binds to an enzyme using an **enzyme-substrate complex**

**Increasing temperature increases the rate of reaction**, but drastic changes may cause denaturation of enzymes.
