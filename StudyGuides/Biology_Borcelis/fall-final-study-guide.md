...
<head>
    <script async src="/www.googletagmanager.com/gtag/js?id=G-0B2RL00V6Q"></script>
    <script>
...
<img width="374" alt="image" src="IMG_0610.jpeg" />
...
<img height="400" alt="image" src="IMG_0595.png" />
...
<img height="400" alt="image" src="IMG_0597.png" />
...
<img height="400" alt="image" src="IMG_0598.png" />

### 9. Carbon cycle

<img height="400" alt="image" src="IMG_0599.jpeg" />
...
<img height="400" alt="image" src="IMG_0601.jpeg" />
...
cell part | function | process involved | consequences to the cell if this cell part is not functioning properly (all in all, the cell DIES)
--- | --- | --- | ---
nucleus | stores DNA | protein synthesis | The cell will not do any work due to a lack of instruction
ribosome | makes proteins | protein synthesis | No proteins are made, so some cell transport fails and organelles can't be fixed.
golgi apparatus | modifies proteins | protein synthesis | proteins cannot be finished synthesizing, and the cell eventually dies.
endoplasmic reticulum | synthesizes lipids, detoxifies drugs, makes carbohydrates | molecule synthesis | cell membranes cannot be fixed
cell membrane | controls what goes in and out of a cell; provides structure and protection | cell transport; protein synthesis | organelles would spill out, and the cell would not be a cell anymore.
mitochondria | convert molecules into ATP | cellular respiration | cell does not have ATP. It halts all energy, needing processes.
chloroplast | makes sugars | photosynthesis | cell cannot obtain energy, so it dies
vacuole | store water/materials | cell transport (bulk transport) | materials are scattered, minimizing efficiency
vesicle | stores and transport materials | cell transport (bulk transport), protein synthesis | materials are scattered, minimizing efficiency
lysosome | breaks down waste | waste recycling | junk will clutter up and make cellular processes less efficient.
...
![alt text](IMG_0607.jpeg)

### 6. Transport through the cell membrane

**osmosis**: the diffusion of water, sometimes needing **aquaporins**(water channel proteins)

**diffusion**: the transport of small molecules and ions through the cell membrane without the use of energy down a concentration gradient.

**facilitated diffusion**: diffusion of larger molecules with the help of channel proteins.

**active transport**: transport across the cell membrane using energy (against a concentration gradient)

![alt text](IMG_0609.jpeg)

### 7. The cell membrane

- The cell membrane is a **lipid bilayer**, with phospholipids arranged in a uniform fashion. The heads (hydrophilic) is facing out, and the tails (hydrophobic) is facing in.
- The cell membrane is selectively permeable, and it supports and protects the cell.
...
Scientists call the cell membrane a **fluid mosaic** because it is composed of many different kinds of molecules (proteins, carbohydrates, lipids)

## Chapters 9 & 10, Carbon Cycling & Energy Aquisition

### 1. Autotrophs vs heterotrophs

Autotrophs make their own food, using **photosynthesis** and/or **chemosynthesis** to store energy in the form of chemical bonds in food. Whenever needed, they use **cellular respiration** to transform food into more directly usable molecules. (Ex. Lettuce harnesses sunlight energy to grow and develop)

Heterotrophs cannot make their own food. They can only use **cellular respiration** to transform food into more usable molecules (ATP, FADH<sub>2</sub>, NADH) (Ex. A lion eats a zebra, and stores some of it as fats and protein. It uses respiration to harness the quick energy it needs while running to catch another zebra.)

### 2. ATP

- ATP is a form of energy used by cells.
- It consists of **adenine**(nitrogen base), **ribose**(pentose sugar), and **three phosphates**.

When the last phosphate breaks off, energy is released for cellular processes such as *active transport, maintaining homeostasis, synthesizing proteins and carbs, and reproducing*

### 3. ATP-ADP cycle

During this cycle, the bond between the last two phosphates is broken, releasing energy. ADP can be reused by phosphorylation, which adds back a phosphate.

<img height="600" alt="image" src="IMG_0604.jpeg" />

### 4. The purpose of photosynthesis

Photosynthesis is crucial for obtaining food from sunlight for plants and animals, but only plants can photosynthesize.

### 5. Organisms that undergo photosynthesis

Plants and some bacteria can undergo photosynthesis (through bacteria do not have chloroplasts. They use thylakoids and chlorophyll.)

### 6. Pigments

a light-absorbing molecule used to harness solar energy

- The green pigment **chlorophyll** is used during photosynthesis.
- Chlorophyll absorbs blue-violet and red colors best.

### 7. The stages of photosynthesis

![alt text](IMG_0605.jpeg)
...
six carbon dioxide + six water | &rarr; | one glucose + six oxygen

### 9. Glycolysis

chemical equation | location | types of organisms
--- | --- | ---
1 glucose &rarr; 2 pyruvic acid (or pyruvate) | cytoplasm | eukaryotes and prokaryotes

### 10. Cellular respiration

chemical equation | location | types of organisms
--- | --- | ---
6O<sub>2</sub> + C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> &rarr; 6CO<sub>2</sub> + 6H<sub>2</sub>O | mitochondria (partly in cytoplasm) | eukaryotes and prokaryotes

### 11. 3 stages of cellular respiration

![Stages of Cellular Respiration](IMG_0606.jpeg)

### 12. Overall reaction for cellular respiration

reactants | arrow | products
--- | --- | ---
6O<sub>2</sub> + C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> | &rarr; | 6CO<sub>2</sub> + 6H<sub>2</sub>O
six oxygen, one glucose | &rarr; | six carbon dioxide, six water

### 13. Aerobic vs anaerobic respiration

**aerobic**: requires oxygen - **the Krebbs cycle**, **Electron Transport Chain**<br>
**anaerobic**: does not require oxygen - **glycolysis**

### 14. Alcoholic Fermentation and Lactic Acid Fermentation
